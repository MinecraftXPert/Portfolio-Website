...
export default function Header() {
  ...
  return (
    <nav className="shadow-sm w-full">
      {/* navbar */}
      <ul className="flex sm:justify-around justify-start items-center p-5 ml-5 sm:gap-0 gap-2">
        <li className="mr-auto text-2xl">
          <a href="#" className="text-3xl">
            Noah
          </a>
        </li>
        <li className="sm:block hidden px-[30px] py-0 text-[14px]">
          <a href="#">Home</a>
        </li>
        <li className="sm:block hidden px-[30px] py-0 text-[14px]">
          <a href="#">About</a>
      ...
      >
        ...
        <svg
          onClick={toggleSideBar}
          className="m-5 w-[25px] cursor-pointer"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 384 512"
        >
